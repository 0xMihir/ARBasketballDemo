...
public class AnchorCreator : MonoBehaviour
{
    ...
    [HideInInspector]
    public bool g_anchorPlaced = false;

    private bool m_anchorPlaced = false;
    ...
    void Update()
    {
        ...
        if (g_anchorPlaced || Input.touchCount == 0)
            return;
        ...
        else if (touch.phase == TouchPhase.Ended && m_anchorPlaced)
        {
            g_anchorPlaced = true;
        }
    }
